          ...
          <div className="hero-inner">
            ...
            <div className="hero-portrait-wrap">
              <div className="hero-portrait" role="img" aria-label="Illustration of Aqilah Rosneddin, AIA Life Advisor">
                {/* Animated SVG illustration — woman in tudung */}
                <svg viewBox="0 0 280 320" fill="none" xmlns="http://www.w3.org/2000/svg" style={{width:"72%",maxWidth:"220px",marginBottom:"0.5rem"}}>
                  <defs>
                    ...
                    <linearGradient id="tudungGrad" x1="0" y1="0" x2="1" y2="1">
                      <stop offset="0%" stopColor="#C8102E"/>
                      <stop offset="100%" stopColor="#8B0A1E"/>
                    </linearGradient>
                    <linearGradient id="tudungInner" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="#E8143A"/>
                    ...
                    <filter id="softShadow" x="-20%" y="-20%" width="140%" height="140%">
                      <feDropShadow dx="0" dy="4" stdDeviation="8" floodColor="#C8102E" floodOpacity="0.12"/>
                    </filter>
                    <style>{`
                      @keyframes floatUp {
                      ...
                      @keyframes smile {
                        0%,100%{d:path("M118 198 Q140 212 162 198")}
                        50%{d:path("M116 196 Q140 214 164 196")}
                      }
                      @keyframes shimmer {
                        0%{opacity:0.4} 50%{opacity:0.8} 100%{opacity:0.4}
                      }
                      @keyframes pulse-ring {
                        0%{r:52;opacity:0.15} 100%{r:68;opacity:0}
                      }
                      .float-group { animation: floatUp 4s ease-in-out infinite; transform-origin: center; }
                      .left-eye { animation: blink 5s ease-in-out infinite; transform-origin: 118px 185px; }
                      .right-eye { animation: blink 5s ease-in-out infinite 0.05s; transform-origin: 162px 185px; }
                      .tudung-shine { animation: shimmer 3s ease-in-out infinite; }
                      .pulse-ring { animation: pulse-ring 2.5s ease-out infinite; }
                    `}</style>
                  </defs>

                  {/* Background glow circle */}
                  <circle cx="140" cy="160" r="110" fill="url(#bgGlow)"/>
                  <circle className="pulse-ring" cx="140" cy="155" r="52" fill="none" stroke="#C8102E" strokeWidth="2"/>

                  {/* === FLOATING GROUP === */}
                  <g className="float-group" filter="url(#softShadow)">

                    {/* ── BODY / JACKET ── */}
                    <path d="M60 310 Q60 250 80 235 Q100 224 140 220 Q180 224 200 235 Q220 250 220 310 Z" fill="url(#jacketGrad)"/>
                    {/* Jacket lapels */}
                    <path d="M140 220 L120 255 L140 248 L160 255 Z" fill="url(#shirtGrad)"/>
                    {/* Jacket collar line */}
                    <path d="M120 255 Q140 265 160 255" stroke="#C8102E" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
                    {/* AIA badge */}
                    <rect x="152" y="258" width="28" height="14" rx="3" fill="#C8102E"/>
                    <text x="166" y="269" textAnchor="middle" fill="#fff" fontSize="6" fontFamily="monospace" fontWeight="700">AIA</text>

                    {/* ── NECK ── */}
                    <rect x="128" y="205" width="24" height="22" rx="8" fill="url(#skinGrad)"/>

                    {/* ── TUDUNG (hijab) outer ── */}
                    {/* Back drape */}
                    <ellipse cx="140" cy="148" rx="72" ry="80" fill="url(#tudungGrad)"/>
                    {/* Side drapes */}
                    <path d="M72 155 Q58 185 65 225 Q80 238 100 230 Q88 200 90 170 Z" fill="#A00C24"/>
                    <path d="M208 155 Q222 185 215 225 Q200 238 180 230 Q192 200 190 170 Z" fill="#A00C24"/>
                    {/* Front head wrap */}
                    <ellipse cx="140" cy="130" rx="60" ry="65" fill="url(#tudungInner)"/>
                    {/* Forehead highlight */}
                    <ellipse cx="132" cy="105" rx="18" ry="10" fill="#E8143A" opacity="0.5" className="tudung-shine"/>
                    {/* Chin drape */}
                    <path d="M95 168 Q95 210 100 218 Q120 228 140 228 Q160 228 180 218 Q185 210 185 168 Q165 178 140 178 Q115 178 95 168 Z" fill="url(#tudungGrad)"/>
                    {/* Inner chin fold highlight */}
                    <path d="M108 185 Q140 195 172 185" stroke="#E8143A" strokeWidth="1.5" fill="none" opacity="0.6"/>

                    {/* ── FACE ── */}
                    <ellipse cx="140" cy="163" rx="46" ry="50" fill="url(#skinGrad)"/>
                    {/* Face shadow sides */}
                    <ellipse cx="100" cy="165" rx="12" ry="28" fill="#E8A878" opacity="0.3"/>
                    <ellipse cx="180" cy="165" rx="12" ry="28" fill="#E8A878" opacity="0.3"/>

                    {/* ── EYEBROWS ── */}
                    <path d="M112 172 Q118 168 128 170" stroke="#7B4A2D" strokeWidth="2.5" strokeLinecap="round" fill="none"/>
                    <path d="M152 170 Q162 168 168 172" stroke="#7B4A2D" strokeWidth="2.5" strokeLinecap="round" fill="none"/>

                    {/* ── EYES ── */}
                    <g className="left-eye">
                      <ellipse cx="118" cy="183" rx="9" ry="7" fill="#fff"/>
                      <ellipse cx="119" cy="183" rx="5.5" ry="5.5" fill="#3D2B1F"/>
                      <ellipse cx="120" cy="183" rx="3" ry="3" fill="#1A0A00"/>
                      <ellipse cx="122" cy="180" rx="1.5" ry="1.5" fill="#fff"/>
                    </g>
                    <g className="right-eye">
                      <ellipse cx="162" cy="183" rx="9" ry="7" fill="#fff"/>
                      <ellipse cx="163" cy="183" rx="5.5" ry="5.5" fill="#3D2B1F"/>
                      <ellipse cx="164" cy="183" rx="3" ry="3" fill="#1A0A00"/>
                      <ellipse cx="166" cy="180" rx="1.5" ry="1.5" fill="#fff"/>
                    </g>
                    {/* Eye lashes */}
                    <path d="M109 179 Q110 176 112 175" stroke="#3D2B1F" strokeWidth="1.2" strokeLinecap="round" fill="none"/>
                    <path d="M126 175 Q128 176 129 179" stroke="#3D2B1F" strokeWidth="1.2" strokeLinecap="round" fill="none"/>
                    <path d="M153 179 Q154 176 156 175" stroke="#3D2B1F" strokeWidth="1.2" strokeLinecap="round" fill="none"/>
                    <path d="M170 175 Q172 176 173 179" stroke="#3D2B1F" strokeWidth="1.2" strokeLinecap="round" fill="none"/>

                    {/* ── NOSE ── */}
                    <path d="M136 188 Q140 196 144 188" stroke="#C8956A" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
                    <circle cx="134" cy="194" r="2" fill="#C8956A" opacity="0.5"/>
                    <circle cx="146" cy="194" r="2" fill="#C8956A" opacity="0.5"/>

                    {/* ── SMILE ── */}
                    <path d="M120 202 Q140 216 160 202" stroke="#C8102E" strokeWidth="2.2" strokeLinecap="round" fill="none"/>
                    {/* Cheek blush */}
                    <ellipse cx="105" cy="196" rx="10" ry="7" fill="#F4A0A0" opacity="0.35"/>
                    <ellipse cx="175" cy="196" rx="10" ry="7" fill="#F4A0A0" opacity="0.35"/>

                    {/* ── HANDS / ARMS ── */}
                    <path d="M80 240 Q70 270 75 295 Q82 305 92 300 Q98 285 95 260 Z" fill="url(#skinGrad)"/>
                    <path d="M200 240 Q210 270 205 295 Q198 305 188 300 Q182 285 185 260 Z" fill="url(#skinGrad)"/>
                    {/* Sleeve cuffs */}
                    <path d="M75 288 Q83 308 95 300" stroke="#1A1A2E" strokeWidth="3" strokeLinecap="round" fill="none"/>
                    <path d="M205 288 Q197 308 185 300" stroke="#1A1A2E" strokeWidth="3" strokeLinecap="round" fill="none"/>

                  </g>{/* end float-group */}

                  {/* Ground shadow */}
                  <ellipse cx="140" cy="308" rx="65" ry="6" fill="#C8102E" opacity="0.07"/>
                </svg>
