              ...
              <div className="hero-portrait" role="img" aria-label="Illustration of Aqilah Rosneddin, AIA Life Advisor">
                <svg viewBox="0 0 300 370" fill="none" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <g className="fig">
                    ...
                    {/* Lace texture row 1 */}
                    <ellipse cx="90" cy="295" rx="7" ry="10" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.35"/>
                    <ellipse cx="108" cy="295" rx="7" ry="10" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.35"/>
                    <ellipse cx="126" cy="295" rx="7" ry="10" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.35"/>
                    <ellipse cx="144" cy="295" rx="7" ry="10" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.35"/>
                    <ellipse cx="162" cy="295" rx="7" ry="10" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.35"/>
                    <ellipse cx="180" cy="295" rx="7" ry="10" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.35"/>
                    <ellipse cx="198" cy="295" rx="7" ry="10" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.35"/>
                    {/* Lace texture row 2 */}
                    <ellipse cx="99" cy="312" rx="7" ry="9" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.25"/>
                    <ellipse cx="117" cy="312" rx="7" ry="9" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.25"/>
                    <ellipse cx="135" cy="312" rx="7" ry="9" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.25"/>
                    <ellipse cx="153" cy="312" rx="7" ry="9" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.25"/>
                    <ellipse cx="171" cy="312" rx="7" ry="9" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.25"/>
                    <ellipse cx="189" cy="312" rx="7" ry="9" fill="none" stroke="#fff" strokeWidth="0.8" opacity="0.25"/>
                    {/* Lace texture row 3 */}
                    <ellipse cx="90" cy="328" rx="6" ry="8" fill="none" stroke="#fff" strokeWidth="0.7" opacity="0.2"/>
                    <ellipse cx="108" cy="328" rx="6" ry="8" fill="none" stroke="#fff" strokeWidth="0.7" opacity="0.2"/>
                    <ellipse cx="126" cy="328" rx="6" ry="8" fill="none" stroke="#fff" strokeWidth="0.7" opacity="0.2"/>
                    <ellipse cx="144" cy="328" rx="6" ry="8" fill="none" stroke="#fff" strokeWidth="0.7" opacity="0.2"/>
                    <ellipse cx="162" cy="328" rx="6" ry="8" fill="none" stroke="#fff" strokeWidth="0.7" opacity="0.2"/>
                    <ellipse cx="180" cy="328" rx="6" ry="8" fill="none" stroke="#fff" strokeWidth="0.7" opacity="0.2"/>
                    <ellipse cx="198" cy="328" rx="6" ry="8" fill="none" stroke="#fff" strokeWidth="0.7" opacity="0.2"/>
                    {/* Dress neckline */}
                    ...
                    {/* Brooch sparkle rays - static */}
                    <line x1="150" y1="271" x2="150" y2="267" stroke="#D4AF6A" strokeWidth="1" opacity="0.7"/>
                    <line x1="155" y1="272" x2="158" y2="269" stroke="#D4AF6A" strokeWidth="1" opacity="0.7"/>
                    <line x1="157" y1="278" x2="161" y2="278" stroke="#D4AF6A" strokeWidth="1" opacity="0.7"/>
                    <line x1="155" y1="283" x2="158" y2="287" stroke="#D4AF6A" strokeWidth="1" opacity="0.7"/>
                    <line x1="150" y1="285" x2="150" y2="289" stroke="#D4AF6A" strokeWidth="1" opacity="0.7"/>
                    <line x1="145" y1="283" x2="142" y2="287" stroke="#D4AF6A" strokeWidth="1" opacity="0.7"/>
                    <line x1="143" y1="278" x2="139" y2="278" stroke="#D4AF6A" strokeWidth="1" opacity="0.7"/>
                    <line x1="145" y1="272" x2="142" y2="269" stroke="#D4AF6A" strokeWidth="1" opacity="0.7"/>
