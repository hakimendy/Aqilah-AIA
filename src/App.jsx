...
const Styles = () => (
  <style>{`
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    /* HERO */
    .hero{padding:110px 6% 80px;display:flex;flex-direction:column;justify-content:center;position:relative;overflow:visible;background:#FFFDF9;}
    ...
    /* PORTRAIT */
    .hero-portrait-wrap{position:relative;display:flex;justify-content:center;align-items:stretch;z-index:1;}
    .hero-portrait{width:100%;aspect-ratio:4/5;background:linear-gradient(160deg,#FFF0F0 0%,#FFF8E7 100%);border-radius:24px;overflow:hidden;border:1px solid rgba(200,16,46,0.12);display:flex;align-items:center;justify-content:center;flex-direction:column;gap:0.5rem;color:#4A5568;font-size:0.85rem;text-align:center;box-shadow:0 32px 80px rgba(200,16,46,0.1),0 8px 24px rgba(0,0,0,0.06);position:relative;min-height:420px;z-index:1;}
