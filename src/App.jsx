...
const Styles = () => (
  <style>{`
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .hero-portrait{width:100%;aspect-ratio:3/4;background:linear-gradient(160deg,#FFF0F0 0%,#FFF8E7 100%);border-radius:24px;overflow:hidden;border:1px solid rgba(200,16,46,0.12);display:flex;align-items:center;justify-content:center;flex-direction:column;box-shadow:0 24px 64px rgba(200,16,46,0.08),0 4px 16px rgba(0,0,0,0.06);position:relative;z-index:1;}
