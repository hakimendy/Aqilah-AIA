...
export default function App() {
  ...
  const handleSubmit = (ev) => {
    ...
    if (Object.keys(e).length === 0) {
      ...
      const msg = [
        `Hi Siti Aqilah! I'd like to request a free consultation.`,
        ``,
        `👤 *Name:* ${form.name}`,
        `📞 *Phone:* ${form.phone}`,
          ...
          <div className="hero-inner">
            <div>
              ...
              <div className="hero-trust">
                {[["BSc","Chem Sciences · UBD"],["4yr+","Client-facing roles"],["AIA","Life Advisor"],["Brunei","Based & licensed"]].map(([n,l])=>(
        ...
        <section className="section section-ivory" id="about" aria-labelledby="about-h2">
          ...
          <div className="about-grid">
            <div className="about-body">
              <p><strong>Aqilah Rosneddin</strong> is an AIA Life Advisor based in Brunei. A BSc Chemical Sciences graduate from Universiti Brunei Darussalam, her background spans healthcare research, pharmaceutical sales, and client communication — all of which now inform how she approaches insurance advising.</p>
              <p>Before joining AIA in December 2025, she spent nearly 4 years as a Telecaller at Octaga Sdn Bhd, building strong interpersonal and CRM skills, followed by a role as Medical Sales Representative at United Pharma — where she learned to explain complex products clearly to clients in the healthcare sector.</p>
              <p>That combination of science, sales, and people skills means she can break down insurance in a way that actually makes sense — no jargon, no pressure, just honest guidance on what fits your life.</p>
              <div className="creds">
                {[
                  "AIA Life Advisor · Dec 2025–Present",
                  "BSc Chemical Sciences · Universiti Brunei Darussalam",
                  "Former Medical Sales Representative · United Pharma",
                  "Research Assistant · Ministry of Health Brunei",
            ...
            <div>
              <div className="about-stats">
                {[["BSc","Chemical Sciences"],["UBD","2020–2024"],["AIA","Dec 2025"],["4yrs+","Client-facing"]].map(([n,l])=>(
              ...
              <blockquote style={{marginTop:"1.5rem",padding:"1.5rem",background:"#FFF5F5",borderRadius:"14px",border:"1px solid rgba(200,16,46,0.1)"}}>
                <p style={{fontSize:"0.875rem",color:"#4A5568",lineHeight:1.75,fontStyle:"italic"}}>"My science background taught me to ask the right questions. My years in client-facing roles taught me how to listen. Insurance is where both come together — understanding your risk, then protecting against it."</p>
                <footer style={{fontSize:"0.78rem",color:"#C8102E",fontWeight:600,marginTop:"0.5rem"}}>— Aqilah Rosneddin, AIA Life Advisor</footer>
              </blockquote>
            </div>
          </div>
        </section>
