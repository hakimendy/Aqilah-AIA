...
const Styles = () => (
  <style>{`
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    /* HERO */
    .hero{min-height:100vh;padding:100px 6% 60px;display:flex;flex-direction:column;justify-content:center;position:relative;overflow:hidden;}
    .hero-bg-shape{position:absolute;top:-120px;right:-200px;width:700px;height:700px;background:radial-gradient(ellipse,rgba(200,16,46,0.06) 0%,transparent 65%);border-radius:50%;pointer-events:none;}
    .hero-bg-shape2{position:absolute;bottom:-80px;left:-150px;width:500px;height:400px;background:radial-gradient(ellipse,rgba(201,151,58,0.06) 0%,transparent 65%);border-radius:50%;pointer-events:none;}
    .hero-inner{display:grid;grid-template-columns:1fr 1fr;gap:5rem;align-items:center;position:relative;z-index:1;}
    .hero-eyebrow{display:inline-flex;align-items:center;gap:8px;font-size:0.78rem;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;color:#C8102E;margin-bottom:1.25rem;font-family:'DM Mono',monospace;}
    .hero-eyebrow::before{content:'';width:24px;height:2px;background:#C8102E;border-radius:2px;}
    .hero h1{font-family:'Playfair Display',serif;font-size:clamp(2.2rem,4.5vw,3.6rem);font-weight:700;line-height:1.15;letter-spacing:-0.01em;color:#1A1A2E;margin-bottom:1.25rem;}
    .hero h1 em{font-style:italic;color:#C8102E;}
    .hero-sub{font-size:1.05rem;color:#4A5568;line-height:1.75;max-width:480px;margin-bottom:2.5rem;}
    ...
    /* BUTTONS */
    .btn-red{background:#C8102E;color:#fff;border:none;border-radius:9px;padding:0.875rem 1.75rem;font-size:0.95rem;font-weight:600;font-family:'DM Sans',sans-serif;cursor:pointer;transition:background 0.2s,transform 0.15s,box-shadow 0.15s;box-shadow:0 4px 18px rgba(200,16,46,0.28);text-decoration:none;display:inline-flex;align-items:center;gap:0.5rem;min-height:48px;}
    .btn-red:hover{background:#a50d27;transform:translateY(-2px);box-shadow:0 8px 28px rgba(200,16,46,0.35);}
    .btn-outline{background:transparent;color:#1A1A2E;border:1.5px solid rgba(26,26,46,0.22);border-radius:9px;padding:0.875rem 1.75rem;font-size:0.95rem;font-weight:600;font-family:'DM Sans',sans-serif;cursor:pointer;transition:border-color 0.2s,background 0.2s,transform 0.15s;text-decoration:none;display:inline-flex;align-items:center;gap:0.5rem;min-height:48px;}
    .btn-outline:hover{border-color:#C8102E;color:#C8102E;background:rgba(200,16,46,0.04);transform:translateY(-2px);}
    .btn-green{background:#25D366;color:#fff;border:none;border-radius:9px;padding:0.875rem 1.75rem;font-size:0.95rem;font-weight:600;font-family:'DM Sans',sans-serif;cursor:pointer;box-shadow:0 4px 18px rgba(37,211,102,0.25);transition:background 0.2s,transform 0.15s;text-decoration:none;display:inline-flex;align-items:center;gap:0.5rem;min-height:48px;}
    ...
    .hero-portrait{width:100%;max-width:420px;aspect-ratio:3/4;background:linear-gradient(160deg,#FFF0F0 0%,#FFF8E7 100%);border-radius:24px;overflow:hidden;border:1px solid rgba(200,16,46,0.1);display:flex;align-items:center;justify-content:center;flex-direction:column;gap:0.5rem;color:#4A5568;font-size:0.85rem;text-align:center;box-shadow:0 24px 64px rgba(200,16,46,0.08),0 4px 16px rgba(0,0,0,0.06);position:relative;}
    .portrait-badge{position:absolute;bottom:1.5rem;left:1.5rem;right:1.5rem;background:rgba(255,253,249,0.95);backdrop-filter:blur(8px);border-radius:12px;padding:1rem 1.25rem;border:1px solid rgba(200,16,46,0.12);box-shadow:0 4px 16px rgba(0,0,0,0.08);}
    .badge-name{font-family:'Playfair Display',serif;font-size:1rem;font-weight:700;color:#1A1A2E;}
    ...
    .portrait-award{position:absolute;top:1.5rem;right:1.5rem;background:#C9973A;color:#fff;border-radius:8px;padding:0.4rem 0.75rem;font-size:0.7rem;font-weight:700;font-family:'DM Mono',monospace;letter-spacing:0.05em;}
    ...
    @media(max-width:960px){
      ...
      .hero-portrait{max-width:300px;margin:0 auto;aspect-ratio:4/3;}
