...
const Styles = () => (
  <style>{`
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .hero-portrait{width:100%;aspect-ratio:4/5;background:linear-gradient(160deg,#FFF0F0 0%,#FFF8E7 100%);border-radius:24px;overflow:hidden;border:1px solid rgba(200,16,46,0.12);display:flex;align-items:center;justify-content:center;flex-direction:column;box-shadow:0 24px 64px rgba(200,16,46,0.08),0 4px 16px rgba(0,0,0,0.06);position:relative;min-height:380px;z-index:1;}
...
export default function App() {
  ...
  const Portrait = () => PORTRAIT_URL ? (
    <img src={PORTRAIT_URL} alt="Aqilah Rosneddin — AIA Life Advisor" className="portrait-photo"/>
  ) : (
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100%",padding:"2rem"}}>
      ...
      <p style={{fontSize:"0.8rem",color:"#9AA5B4",textAlign:"center"}}>Aqilah Rosneddin</p>
    </div>
  );
